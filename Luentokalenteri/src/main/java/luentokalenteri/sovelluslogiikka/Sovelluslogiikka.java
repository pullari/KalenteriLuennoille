...
public class Sovelluslogiikka {
     ...
     *
     * @see
     * luentokalenteri.domain.tiedostonkasittelija.TiedostoonTallentaja#tallennaTilanne(java.util.Map)
     ...
     *
     * @see
     * luentokalenteri.domain.tiedostonkasittelija.TiedostonLukija#puraTallennetut(java.util.Map)
