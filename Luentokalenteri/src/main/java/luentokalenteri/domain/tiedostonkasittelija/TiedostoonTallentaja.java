...
public class TiedostoonTallentaja {
    ...
    /**
     * Metodi, joka alustaa FileWriterin ja huolehtii siitä, ettei tapahdu
     * virhettä sen vuoksi
     *
    ...
    /**
     * Metodi kokoaa merkinnöistä ja päivistä tallennettavat String esitykset ja
     ...
     * @throws IOException Koska käytetään FileWriteria on IOExpception
     * heitettävä
     */
    ...
    /**
     * Metodi huolehtii, että tallennettavat tiedot tallennetaan oikeassa
     * muodossa
     *
